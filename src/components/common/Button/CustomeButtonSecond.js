...
export default class CustomeButtonSecond extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    render() {
        ...
        return (
            <div className={this.state.active ? 'custome-button-second custome-button-second-active' : 'custome-button-second'}>
                <Button
                    {...rest}
